...
## Задачи 18 марта 2025
- [ ] Перенести функционал modbus Bronkhorst из-за поломки расходомеров :)
 - [ ] Настроить подключение
    - [ ] Фунция ответ от устройства помещает значения в указатель на данные, а потом в process events забирай эти данные
