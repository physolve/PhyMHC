...
## Задачи 20 марта 2025
- [ ] Сделать схему и расчет с одним расходомером
    - [ ] Перерисовать схему
    - [x] Поместить upstream - downstream как один, считать через один
        - [x] Из LaNi - в TiFe открой 2 и 5, из TiFe - в LaNi открой 4 и 3, из компрессор в TiFe 1, 2 и 5
